...
const ProductDetail: React.FC = () => {
  ...
  if (!product) {
    return <div className="p-10 text-center">পণ্যটি খুঁজে পাওয়া যায়নি।</div>;
  }
    ...
    <div className="pb-10">
      ...
      <div className="px-4 mt-6">
        <div className="flex justify-between items-start mb-2">
          <div>
            <span className="text-xs text-zinc-500 uppercase tracking-widest mb-1 block">{product.category}</span>
        ...
        {product.sizes.length > 0 && (
          <div className="mb-8">
            <h3 className="text-sm font-bold mb-3 uppercase tracking-wider">সাইজ সিলেক্ট করুন</h3>
        ...
        {/* Description */}
        <div className="mb-8">
          <h3 className="text-sm font-bold mb-3 uppercase tracking-wider">বিস্তারিত</h3>
        ...
        <div className="flex gap-4">
          <button
            ...
            className="flex-1 h-14 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-2xl font-bold flex items-center justify-center gap-2 shadow-xl shadow-zinc-900/10 dark:shadow-white/5 active:scale-95 transition-transform"
          >
